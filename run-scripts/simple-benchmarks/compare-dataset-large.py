...
def DataLoaderDifference(data, name, batch_size = 32, shuffle = True, num_workers = 7, N_sample=10000):
...
if __name__ == '__main__':
    ...
    parser.add_argument("-N", "--N_sample", help="Number of samples to extract", default=10000)
    parser.add_argument("-ff", "--file_format", help="Which file format to benchmark", default='squashfs')
