...
srun singularity exec -B $SQUASH:/train_images:image-src=$IMAGES $CONTAINER bash -c '$WITH_CONDA && source ../../venv-extension/bin/activate && python compare-dataset-large.py -n 7 -ff "squashfs" -N 2000000'
