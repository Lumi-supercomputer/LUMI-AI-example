...
IMAGES=/
srun singularity exec -B $SQUASH:/train_images:image-src=$IMAGES $CONTAINER bash -c '$WITH_CONDA && source ../../venv-extension/bin/activate && python compare-dataset-tiny.py -n 1 -ff "squashfs" -N 100000'
